...
PDF_DOWNLOAD_LINK = "https://www.arenaccountymi.gov/Docs/Clerk/ELECTION/2022/Nov%202022%20StatementOfVotesCast.pdf"
PAGE_START = 3
PAGE_END = 3
...
download_pdf(PDF_DOWNLOAD_LINK, "arenac.pdf")

with pdfplumber.open("arenac.pdf") as pdf:
