...
PDF_DOWNLOAD_LINK = "https://cms2.revize.com/revize/algercounty/document_center/Departments/Clerk_RoD/Elections/2022/November%208,%202022%20General%20Election.pdf"
PAGE_START = 3
PAGE_END = 3
...
download_pdf(PDF_DOWNLOAD_LINK, "alger.pdf")

with pdfplumber.open("alger.pdf") as pdf:
    ...
    for i in range(PAGE_START, PAGE_END + 1):
        ...
        if extracted_data:
            ...
            df_new['DEM'] = temp_df.iloc[:, 4]       # Adjust 3 to the column index for DEM votes
            df_new['REP'] = temp_df.iloc[:, 6]       # Adjust 5 to the column index for REP votes
