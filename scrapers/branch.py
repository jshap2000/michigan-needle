...
PDF_DOWNLOAD_LINK = "https://branchcounty.gov/wp-content/uploads/delightful-downloads/2023/04/NOV-22-ELECTION-RESULTS.pdf"
PAGE_START = 2
PAGE_END = 2
...
download_pdf(PDF_DOWNLOAD_LINK, "branch.pdf")
...
# Usage example:
input_pdf_path = 'branch.pdf'
output_pdf_path = 'branch.pdf'
